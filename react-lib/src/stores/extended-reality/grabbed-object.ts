...
interface GrabbedObjectState {
    ...
    // sendGrabRequest: (object: GrabbableObject) => Promise<boolean>;
...
export const useGrabbedObjectStore = createStore<GrabbedObjectState>((set, get) => ({
...
//         const request =
//         get().grabRequests.get(object) || get().sendGrabRequest(object);
