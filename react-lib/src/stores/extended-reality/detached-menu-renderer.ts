// // TODO: Use after services and utils fully migrated
...
// export default class DetachedMenuRenderer {
...
//       return;
//     }
//     const object = useApplicationRendererStore.getState().getMeshById(detachedMenu.entityId);
...
//       useDetachedMenuGroupsStore.getState().addDetachedMenuLocally(
//         menu,
...
//     const mesh = useApplicationRendererStore.getState().getMeshById(popupData.entityId);
//     if (!isEntityMesh(mesh)) {
//       return;
//     }
//     const worldPosition = useApplicationRendererStore.getState().getGraphPosition(mesh);
//     worldPosition.y += 0.3;
