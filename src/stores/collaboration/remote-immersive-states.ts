...
// This state is used to represent other collaboration room members being in the immersive view mode
...
export const useRemoteImmersiveStateStore = create<RemoteImmersiveState>(
  (set) => ({
