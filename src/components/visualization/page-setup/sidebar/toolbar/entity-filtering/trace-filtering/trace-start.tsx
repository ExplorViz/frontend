...
export type TraceStartHandle = {
  setValue: (value: number) => void;
  reset: () => void;
};

const TraceStart = forwardRef<TraceStartHandle, TraceStartProps>(
  function TraceStart(
    { traces, remainingTraceCount, initialTraceCount, updateStartTimestamp },
    ref
  ) {
    ...
    useImperativeHandle(ref, () => ({
      ...
      reset: () => {
        onTimestampUpdate();
        updateStartTimestamp(timestamps.min);
      },
    }));
