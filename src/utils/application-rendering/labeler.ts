...
import ClazzLabelMesh from '../../view-objects/3d/application/clazz-label-mesh';
import ComponentMesh from '../../view-objects/3d/application/component-mesh';
import ComponentLabelMesh from '../../view-objects/3d/application/component-label-mesh';
