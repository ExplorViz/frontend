...
self.addEventListener(
  ...
  function (e) {
    ...
    const classData = e.data.classData;

    const cityLayout = applyBoxLayout(structureData, dynamicData, classData);
...
function applyBoxLayout(application, allLandscapeTraces, classData) {
