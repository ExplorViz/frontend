...
import {
  RoomListRecord,
  isRoomListRecord,
} from 'collaborative-mode/utils/room-payload/receivable/room-list';
import { RoomCreatedResponse } from 'collaborative-mode/utils/room-payload/receivable/room-created';
import { InitialRoomPayload } from 'collaborative-mode/utils/room-payload/sendable/initial-room';
import {
  LobbyJoinedResponse,
  isLobbyJoinedResponse,
} from 'collaborative-mode/utils/room-payload/receivable/lobby-joined';
