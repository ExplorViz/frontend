...
import composeContent, { EntityMesh, getIdOfEntity, getTypeOfEntity } from "virtual-reality/utils/vr-helpers/detail-info-composer";
...
export default class DetailInfoMenu extends InteractiveMenu implements DetachableMenu {
    ...
    onOpenMenu() {
        super.onOpenMenu();
        if(this.firstTime){ // otherwise it duplicates when detaching
          this.createMenu();
        }
    }
