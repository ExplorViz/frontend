...
import { INITIAL_LANDSCAPE_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/receivable/landscape';
import { ANNOTATION_EDIT_RESPONSE_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/receivable/response/annotation-edit-response';
import { ANNOTATION_RESPONSE_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/receivable/response/annotation-response';
import { ANNOTATION_UPDATED_RESPONSE_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/receivable/response/annotation-updated-response';
import { SELF_CONNECTED_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/receivable/self-connected';
import { TIMESTAMP_UPDATE_TIMER_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/receivable/timestamp-update-timer';
import { USER_CONNECTED_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/receivable/user-connected';
import { USER_DISCONNECTED_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/receivable/user-disconnect';
...
import { ANNOTATION_CLOSED_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/sendable/annotation-closed';
import { ANNOTATION_EDIT_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/sendable/annotation-edit';
import { ANNOTATION_OPENED_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/sendable/annotation-opened';
import { ANNOTATION_UPDATED_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/sendable/annotation-updated';
import { APP_OPENED_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/sendable/app-opened';
import { CHANGE_LANDSCAPE_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/sendable/change-landscape';
import { COMPONENT_UPDATE_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/sendable/component-update';
import { HEATMAP_UPDATE_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/sendable/heatmap-update';
import { HIGHLIGHTING_UPDATE_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/sendable/highlighting-update';
import { MOUSE_PING_UPDATE_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/sendable/mouse-ping-update';
import { PING_UPDATE_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/sendable/ping-update';
import { SHARE_SETTINGS_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/sendable/share-settings';
...
import { OBJECT_CLOSED_RESPONSE_EVENT } from 'explorviz-frontend/utils/extended-reality/vr-web-wocket-messages/receivable/response/object-closed';
import { OBJECT_GRABBED_RESPONSE_EVENT } from 'explorviz-frontend/utils/extended-reality/vr-web-wocket-messages/receivable/response/object-grabbed';
import { JOIN_VR_EVENT } from 'explorviz-frontend/utils/extended-reality/vr-web-wocket-messages/sendable/join-vr';
import { OBJECT_MOVED_EVENT } from 'explorviz-frontend/utils/extended-reality/vr-web-wocket-messages/sendable/object-moved';
import { APP_CLOSED_EVENT } from 'explorviz-frontend/utils/extended-reality/vr-web-wocket-messages/sendable/request/app-closed';
import { DETACHED_MENU_CLOSED_EVENT } from 'explorviz-frontend/utils/extended-reality/vr-web-wocket-messages/sendable/request/detached-menu-closed';
...
import { USER_CONTROLLER_CONNECT_EVENT } from 'explorviz-frontend/utils/extended-reality/vr-web-wocket-messages/sendable/user-controller-connect';
import { USER_CONTROLLER_DISCONNECT_EVENT } from 'explorviz-frontend/utils/extended-reality/vr-web-wocket-messages/sendable/user-controller-disconnect';
import { USER_POSITIONS_EVENT } from 'explorviz-frontend/utils/extended-reality/vr-web-wocket-messages/sendable/user-positions';
import { CHAT_MESSAGE_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/receivable/chat-message';
import { CHAT_SYNC_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/receivable/chat-syncronization';
import { io, Socket } from 'socket.io-client';
import { USER_KICK_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/sendable/kick-user';
import { MESSAGE_DELETE_EVENT } from 'explorviz-frontend/utils/collaboration//web-socket-messages/sendable/delete-message';
