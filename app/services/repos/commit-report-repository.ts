...
export function isCommitReport(commitReport: any): commitReport is CommitReport {
    return (
      commitReport !== null &&
      ...
      (typeof commitReport.modified === 'undefined' || typeof commitReport.modified.every((x: any) => typeof x === 'string')) &&
      (typeof commitReport.deleted === 'undefined' || typeof commitReport.deleted.every((x: any) => typeof x === 'string')) &&
      (typeof commitReport.added === 'undefined' || typeof commitReport.added.every((x: any) => typeof x === 'string')) &&
...
export default class CommitReportRepository extends  Service.extend(Evented) {
  ...
  //@tracked
  commitReports: Map<string, CommitReport> = new Map<
    string,
    CommitReport
  >();
