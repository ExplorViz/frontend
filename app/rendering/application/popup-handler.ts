...
export default class PopupHandler {
  ...
  @action
  addPopup({
    mesh, position, pinned, replace, menuId, sharedBy, hovered,
  }: { mesh: THREE.Object3D, position: Position2D, pinned?: boolean, replace?: boolean, menuId?: string, sharedBy?: string, hovered?: boolean }) {
    if (isEntityMesh(mesh)) {
