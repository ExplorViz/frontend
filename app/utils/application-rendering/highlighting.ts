...
export function highlight(
  ...
  // consideredClazzes = [], // so we do not turn already "selected" classes transparent
) {
  ...
  (applicationObject3D.highlightedEntity as BaseMesh[]).push(mesh);
