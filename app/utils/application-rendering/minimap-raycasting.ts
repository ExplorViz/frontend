...
const groundPlane = new THREE.Plane(new THREE.Vector3(0, -1, 0), 0.108); // Virtual ground Plane used to intersect raycast
let cam;

export function raycastToGround(camera: THREE.Camera): [THREE.Vector3, THREE.Mesh] {
  ...
  return [intersectionPoint, sphere];
}
