...
import VrInputManager from 'explorviz-frontend/utils/extended-reality/vr-controller/vr-input-manager';
import {
  EntityMesh,
  isEntityMesh,
...
import UserListItem from 'explorviz-frontend/utils/extended-reality/view-objects/vr/user-list-item';
