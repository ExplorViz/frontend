...
import { VRControllerThumbpadLabelPositions } from 'explorviz-frontend/utils/extended-reality/vr-controller/vr-controller-label-positions';
...
export enum VRControllerThumbpadVerticalDirection {
  NONE,
  UP,
  DOWN,
}
export enum VRControllerThumbpadHorizontalDirection {
  NONE,
  RIGHT,
  LEFT,
}
export enum VRControllerThumbpadDirection {
  NONE,
  UP,
  RIGHT,
  DOWN,
